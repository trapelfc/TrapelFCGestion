...
import { ArrowLeft, ChevronLeft, ChevronRight, PlusCircle, Trash2, Mail } from 'lucide-react';
...
import { AddPlanningEventModal, type PlanningEventFormData } from '@/components/planning/add-planning-event-modal';
import { EmailPlanningModal } from '@/components/planning/email-planning-modal';
...
import type { CommuneDefinition, FieldDefinition, PlanningEvent, PlannableUnit } from '@/types/planning';
import { STADES_CONFIG_STORAGE_KEY, PLANNING_EVENTS_STORAGE_KEY } from '@/config/planning-constants';
import { getStadesConfigFromStorage, getPlanningEventsFromStorage, savePlanningEventsToStorage } from '@/lib/planningUtils';
...
export default function OccupationStadesPage() {
  ...
  const [isEmailPlanningModalOpen, setIsEmailPlanningModalOpen] = useState(false); 
